...
import FileLogics.File;
import FileLogics.FileManager;
import FileLogics.PhysMemory;
import FormElements.CustomPanel;
...
public class DrawForm {
    ...
    private JTextField textFieldName = new JTextField("default");
    ...
    public void workButtons() {
        ...
        buttonSetMemory.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                customPanel = new CustomPanel(physMemory);
                customPanel.setBounds(220, 10, 900, 650);
    ...
    private void changeTree(DefaultMutableTreeNode treeFile, ArrayList<File> child) {
        for (File file : child) {
